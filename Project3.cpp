...
#include "Data/FlightEdge.h"
#include "Data/FlightGraph.h"
...
void computePressed(tgui::GuiBase* gui, string* startPointPointer, set<string>* destinationsPointer, string* airLinePointer, string* quarterPointer, string* outputPointer, map <string, string>* airlineDataFinal)
{
    //int startPointFinal = (*locationData)[*startPointPointer];
    //set <int> destinationsFinal;
    //auto iter = destinationsPointer->begin();
    string airlineFinal = (*airlineDataFinal)[*airLinePointer];
    string* airlineFinalPointer = &airlineFinal;
    //cout << airlineFinal;

    string output = compute(startPointPointer, destinationsPointer, airlineFinalPointer, quarterPointer);
    *outputPointer = output; 
    createOutput(*gui, startPointPointer, destinationsPointer, airlineFinalPointer, quarterPointer, outputPointer); //prints output. Do this after storing the output in *outputPointer, don't change this method
    ...
    tgui::Button::Ptr& computeButton, map<string, string>& airlineData, map <string, int>& locationData, string* startPointPointer, set<string>* destinationsPointer, string* airLinePointer, string* quarterPointer, string* outputPointer)
{
    ...
    try
    {
        ...
        computeButton->onPress(&computePressed, &gui, startPointPointer, destinationsPointer, airLinePointer, quarterPointer, outputPointer, airlineDataFinal);
        return true;
    }
